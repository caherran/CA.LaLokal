...
{
    public class CreateInmuebleCommandValidator : AbstractValidator<CreateInmuebleCommand>
    {
        public CreateInmuebleCommandValidator(IRegexValidationConstants regexConstants)
        {
