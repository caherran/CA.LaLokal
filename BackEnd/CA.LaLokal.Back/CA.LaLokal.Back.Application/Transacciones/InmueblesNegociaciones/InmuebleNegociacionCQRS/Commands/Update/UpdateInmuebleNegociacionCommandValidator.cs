...
{
    public class UpdateInmuebleNegociacionCommandValidator : AbstractValidator<UpdateInmuebleNegociacionCommand>
    {
        public UpdateInmuebleNegociacionCommandValidator(IRegexValidationConstants regexConstants)
        {
