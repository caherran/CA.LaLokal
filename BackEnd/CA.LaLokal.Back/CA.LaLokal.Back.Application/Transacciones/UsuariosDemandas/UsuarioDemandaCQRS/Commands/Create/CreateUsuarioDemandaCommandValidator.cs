...
{
    public class CreateUsuarioDemandaCommandValidator : AbstractValidator<CreateUsuarioDemandaCommand>
    {
        public CreateUsuarioDemandaCommandValidator(IRegexValidationConstants regexConstants)
        {
