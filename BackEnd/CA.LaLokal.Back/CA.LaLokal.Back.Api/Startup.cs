...
namespace CA.LaLokal.Back.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration.GetConnectionString("Entities"), b => b.MigrationsAssembly(typeof(CA.LaLokal.Back.Infraestructure.DependencyRegister).Assembly.GetName().Name));
            });
            ...
            {
                configure.Title = "CA.LaLokal.Back API";
